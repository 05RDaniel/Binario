...
public class BinarioDecimal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Introduzca un número que sea mayor que 0");                                                           
            n = sc.nextInt();
        } while (n <= 0); /*He cambiado "i" por "n", que es la variable en la que se almacena el número dado por el usuario*/
    ...
    public static void decBin(int n) {
        if (n < 2) {
            ...
            decBin(n / 2);
            System.out.print(n % 2); /*Aqui he cambiado el símbolo, ya que se ha de mostrar el resto, que será 1 o 0*/
        }
    }
}